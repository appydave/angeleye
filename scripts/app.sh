#!/usr/bin/env bash
# AngelEye app control — start the app DETACHED so it outlives the shell that launched it
...
APP="AngelEye"
SERVER_PORT="${ANGELEYE_SERVER_PORT:-5051}"
CLIENT_PORT="${ANGELEYE_CLIENT_PORT:-5050}"
