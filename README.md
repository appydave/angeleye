...
| ---------- | ---------------------------- | -------------------------------------------------------- |
| Client     | React 19 + Vite 7            | UI on port 5050, proxies `/api`, `/health`, `/socket.io` |
| Server     | Express 5 + Socket.io        | REST API + real-time events on port 5051                 |
...
| ---------------- | ---- | ---------------------------------- |
| Client (Vite)    | 5050 | `client/vite.config.ts`            |
| Server (Express) | 5051 | `.env`, `server/src/config/env.ts` |
