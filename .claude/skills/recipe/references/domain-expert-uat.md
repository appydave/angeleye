...
>
> _Example answer:_ "Angela is a care coordinator. She calls participants 'clients'. She thinks of companies as 'providers' and sites as 'houses'. She's comfortable with web forms but not with dev tools."
...
>
> _Example answer:_ "1. Set up a new care provider and their sites. 2. Add support workers to a site. 3. Onboard a new client (participant). 4. Complete a client's support profile. 5. Record what happened during a shift. 6. Print the 30-second handover summary."
